...
github_url = "https://raw.githubusercontent.com/spikestone/projekts/main/testappstarter.py"
# Pfad zur lokalen Datei des Skripts
current_directory = os.getcwd()
local_path = current_directory + "/testappstarter.py"
